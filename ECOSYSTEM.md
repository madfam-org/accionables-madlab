...
| **Selva** | `madfam-org/selva-office` (`selva-office` former name) | LLM inference routing + agent orchestration |
...
- **Inference**: every LLM call should route through Selva
  (`selva-office`; former repo name `selva-office`) at `/v1` (OpenAI-compatible). Do not talk directly
